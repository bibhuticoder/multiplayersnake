...
function checkCollission(snake, cir2) {
    ...
    var dis = Math.sqrt(Math.pow(snake.body[0].x - cir2.pos.x, 2) + Math.pow(snake.body[0].y - cir2.pos.y, 2));
...
window.onkeydown = function (e) {
    ...
    if (e.keyCode >= 37 && e.keyCode <= 40) {
        ...
        if (e.keyCode === 38 && snakes[myId].direction !== 'down') { //up 
            changeDir('up');
        } else if (e.keyCode === 40 && snakes[myId].direction !== 'up') { //down 
            changeDir('down');
        } else if (e.keyCode === 39 && snakes[myId].direction !== 'left') { //right
            changeDir('right');
        } else if (e.keyCode === 37 && snakes[myId].direction !== 'right') { //left
            changeDir('left');
        }
